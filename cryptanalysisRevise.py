...
def decrypt():
    ...
    if(N == key):
        ...
        print("\nIt took:" ,time_taken.seconds, " seconds to break the RSA! ")
    else:
        print("Failed")
...
while True:
    def main():
        print("-------CryptoSystem-------")
        try:
            input_num = int(input("Enter your choice 1.Cryptanalysis: 2.Exit: "))
            if input_num == 2:
                exit()
            elif input_num == 1:
                decrypt()
            ...
            print("Invalid Input somewhere, try again")
